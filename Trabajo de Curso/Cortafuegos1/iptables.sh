...
iptables -A INPUT -p tcp -m multiport --sports 53,80,443,8443 -j ACCEPT # DNS, HTTP, HTTPS, Campus
...
iptables -A OUTPUT -p tcp -m multiport --dports 53,80,443,8443 -m state --state NEW -j ACCEPT # DNS, HTTP, HTTPS, Campus
